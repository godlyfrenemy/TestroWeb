...
<div class="answer u-border-2 u-border-grey-75 u-container-style u-list-item u-repeater-item" style="padding: 5px;">
    <div class="u-container-layout u-similar-container u-valign-top u-container-layout-8">
            <input type="hidden" id="question-<?=$answer_data['answer_id']?>" value="<?=$question['question_id']?>">
            <input class="u-border-2 u-border-black u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-input-1" name="name-answer"  placeholder="Введіть відповідь" value="<?=$answer_data['text']?>" type="text" required>
            </input>
            <?php 
